...
Set objWorkbook = objExcel.Workbooks.Open("\\BG279K12FPS01\Administrative$\Reporting\Data_Reporting\Private\1. Projects\2. Exeter\4. Standard reports\1. Heathrow\Heathrow MI Master.xlsm")

objExcel.Application.Visible = false
objExcel.run "Refresh_Data"
...
Set MyItem = MyApp.CreateItem(0)
With MyItem
    .To = "joanne.griffiths@sitel.com; matthew.haynes@sitel.com; wendy.denham2@sitel.com"
    .Subject = "Heathrow MI has been updated"
